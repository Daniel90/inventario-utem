...
{
	return View::make('cuerpo.prueba2');
});

//Route::get('/bienesbajacosto', function()
//{
//	return View::make('cuerpopagina.bienesbajacosto');
//});

Route::get('/historia', function()
{
	return View::make('cuerpopagina.historia');
});

Route::get('/himno', function()
{
	return View::make('cuerpopagina.himno');
});

Route::get('/bienesalta', function()
{
	return View::make('cuerpopagina.bienesalta');
});

Route::get('/bienesbaja', function()
{
	return View::make('cuerpopagina.bienesbaja');
});

Route::get('/centrodecosto', function()
{
	return View::make('cuerpopagina.centrodecosto');
});

Route::get('/contactos', function()
{
	return View::make('cuerpopagina.contactos');
});

Route::get('/ubicacion', function()
{
	return View::make('cuerpopagina.ubicacion');
});

Route::get('/mision', function()
{
	return View::make('cuerpopagina.mision');
});
...
Route::post('/altaBien', function()      //formulario alta bien
{
	...
	//{
		...
		for($i=1;$i<=4;$i++)
		{
			if(Input::get('codigoCentro_select') == "centro de costo ".$i.".")
				$bien->centrocostos_id = "10000".$i; 
		}
...
Route::get('/bienesbaja', function()
{
	//$centros = Centrocosto::all(array('id'));
	$bajabienes = Bajabien::all(array('id'));
	return View::make('cuerpopagina.bienesbaja')->with("bajabienes",$bajabienes);
});
...
Route::get('/bienesalta', function()
{
	...
	return View::make('cuerpopagina.bienesalta')->with("bienes",$bienes);
});
...
Route::get('/centrodecosto', function()
{
	...
	return View::make('cuerpopagina.centrodecosto')->with("centros",$centros);
});

Route::get('/bienescosto', function()
{
	$historiales = DB::table('centrocostos')->join('historiales','centrocostos.id','=','historiales.centrocostos_id')->get();
	return View::make('cuerpopagina.bienescosto')->with("historiales",$historiales);
});

Route::get('/bienesbajacosto', function()
{
	$bajas = DB::table('centrocostos')->join('bajabienes','centrocostos.id','=','bajabienes.centrocostos_id')->get();
	return View::make('cuerpopagina.bienesbajacosto')->with("bajas",$bajas);
});
