...
$(document).ready( function () {
    ...
    <body>
      ...
      <div id="accordion">
        ...
        <div id="content" class="ui-layout-center">
          <hgroup>
            <legend>
              ...
              <h3 class="text-info" style="text-align:center;">Busqueda y Vista de Bienes en Baja</h3>
            </legend>
          </hgroup>
          <div id="container">
        ...
        <tbody>
          @if($bajabienes)
            @foreach($bajabienes as $bajabiene)
              <tr class="gradeA">
                <td class="center">{{ $bajabiene -> id }}</td>  
                <td class="center">{{ $centrocostos -> centrodecostos_id }}</td> 
                <td class="center">{{ $bajabiene -> tipo }}</td>
                <td class="center">{{ $bajabiene -> nombre }}</td> 
                <td class="center">{{ $bajabiene -> modelo }}</td> 
                <td class="center">{{ $bajabiene -> marca }}</td> 
                <td class="center">{{ $bajabiene -> numeroserie }}</td> 
                
                <td class="center">{{ $bajabiene -> fechadeldocumento }}</td> 
                
                <td class="center">{{ $bajabiene -> fechadecreto }}</td> 
                
                <td class="center">{{ $bajabiene -> motivobaja }}</td> 
               
                <td class="center">{{ $bajabiene -> observaciones }}</td> 
              </tr>
            @endforeach
          @endif   
        </tbody>
