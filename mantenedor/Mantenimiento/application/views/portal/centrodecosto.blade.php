        ...
        <div id="content" class="ui-layout-center">
          <hgroup>
            <legend>
              ...
              <h3 class="text-info" style="text-align:center;">Busqueda y Vista de Centro de Costo</h3>
            </legend>
          </hgroup>
        ...
        <tbody>
          @if($centros)
            @foreach($centros as $centro)
              <tr class="gradeA">
                <td class="center">{{ $centro -> id }}</td>
                <td class="center">{{ $centro -> encargado }}</td>
                <td class="center">{{ $centro -> departamento }}</td>
                <td class="center">{{ $centro -> sede }}</td>
                <td class="center">{{ $centro -> telefono }}</td>
              </tr>
            @endforeach
          @endif   
        </tbody>
